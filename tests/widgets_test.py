...
class TestWidgets:
    ...
    class TestTabsPage:
        ...
        def test_tabs(self, driver):
            ...
            assert origin_button == 'Origin' and what_content != 0, 'the tab "origin" was not pressed or the text is missing'
            assert use_button == 'Use' and what_content != 0, 'the tab "use" was not pressed or the text is missing'
