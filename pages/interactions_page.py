...
class SortablePage(BasePage):
    ...
    def change_list_order(self):
        ...
        item_list = random.sample(self.element_are_visible(self.locators.LIST_ITEM), k=3)
        item_what = item_list[0]
        item_where = item_list[2]
    ...
    def change_grid_order(self):
        ...
        item_list = random.sample(self.element_are_visible(self.locators.GRID_ITEM), k=3)
        item_what = item_list[0]
        item_where = item_list[2]
        self.action_drag_and_drop_to_element(item_what, item_where)
